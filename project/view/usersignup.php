...
<center>
<img src = "https://img.freepik.com/free-vector/eye-care-logo_20448-218.jpg?w=360">
</center>
<body bgcolor="Yellow">
    <center>
        <h1>Welcome to the Hospital Care.</h1><br>
        <h3><p>Please Signup to this from to move on.</p></h3><br><br>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <center>
                <table>
                    ...
                    <tr>
                        <td>
                            <label>Attach your image or file :&nbsp;&nbsp;&nbsp;</label>
